...
import Checkbox from "../../Checkbox"; // plasmic-import: aDL9-1EAZR2t/component
...
import "./PlasmicCheckboxGroup.css"; // plasmic-import: 9oIwq5wuMKnH/css
  ...
  return (
    <BaseCheckboxGroup
      ...
      className={classNames(
        ...
        "CheckboxGroup__ariaCheckboxGroup___1U8F"
      )}
    ...
    >
        ...
        defaultContents: (
          <div
            className={classNames(
              ...
              "CheckboxGroup__freeBox___1E95M"
            )}
          >
            <Checkbox
              className={classNames(
                "__wab_instance",
                "CheckboxGroup__checkbox___0Zhe1"
              )}
              label={"Option 1"}
              value={"option1"}
            />
            ...
            <Checkbox
              className={classNames(
                "__wab_instance",
                "CheckboxGroup__checkbox__izMxc"
              )}
              label={"Option 2"}
              value={"option2"}
            />
            ...
            <Checkbox
              className={classNames(
                "__wab_instance",
                "CheckboxGroup__checkbox__l6QBd"
              )}
              label={"Option 3"}
              value={"option3"}
            />
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames(
            "__wab_instance",
            "CheckboxGroup__description__oxTpk"
          )}
        >
          {renderPlasmicSlot({
...
export const PlasmicCheckboxGroup__HeadOptions = {
