...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: 1D-b2FrFnV97/component
...
import "./PlasmicPopover.css"; // plasmic-import: MeEN4jD99Kmq/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "Popover__ariaDialogTrigger__dgTb"
      )}
      dialog={
        <BasePopover
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", "Popover__button__gFat")}
            label={"Open Popover"}
          />
        ),
...
export const PlasmicPopover__HeadOptions = {
