...
import SliderThumb from "../../SliderThumb"; // plasmic-import: uoKPtXccdxwM/component
...
import "./PlasmicRangeSlider.css"; // plasmic-import: RC6Hgg8rJm-6/css
  ...
  return (
    <BaseSlider
      ...
      className={classNames(
        ...
        "RangeSlider__ariaRangeSlider__ioZ7"
      )}
      defaultValue={[20, 50]}
    ...
    >
      ...
      >
        ...
        {$props.showOutputText ? (
          <BaseSliderOutput
            ...
            className={classNames(
              "__wab_instance",
              "RangeSlider__ariaSliderOutput__jH0Rg"
            )}
          >
            <div
      ...
      >
        <div
          ...
          className={classNames(
            "plasmic_default__all",
            "RangeSlider__background___6FrIu"
          )}
        >
          <BaseSliderTrack
            ...
            className={classNames(
              "__wab_instance",
              "RangeSlider__ariaSliderTrack__io6MG"
            )}
            progressBar={
              $props.filled ? (
                <div
                  ...
                  className={classNames(
                    "plasmic_default__all",
                    "RangeSlider__foreground__nFzaj"
                  )}
                />
              ) : null
            }
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <SliderThumb
                  className={classNames(
                    "__wab_instance",
                    "RangeSlider__sliderThumb___9YtXv"
                  )}
                />
              ),
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames(
            "__wab_instance",
            "RangeSlider__description__ppunf"
          )}
        />
      ) : null}
    </BaseSlider>
...
export const PlasmicRangeSlider__HeadOptions = {
