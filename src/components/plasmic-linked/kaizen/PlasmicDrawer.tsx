...
import "./PlasmicDrawer.css"; // plasmic-import: B2pKspFGYbfC/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "Drawer__ariaDialogTrigger__njLQw",
        {
          Drawer__ariaDialogTriggernoTrigger__njLQwurZbM: hasVariant(
            $state,
            "noTrigger",
            "noTrigger"
          )
      ...
      dialog={
        <BaseModal
          ...
          className={classNames("__wab_instance", "Drawer__ariaModal__nqNA", {
            Drawer__ariaModalnoTrigger__nqNAurZbM: hasVariant(
              $state,
              "noTrigger",
              "noTrigger"
            )
          ...
          modalOverlayClass={classNames({ pcls_ObsTFuz_xOYQ: true })}
        ...
        >
          <BaseDialog
            ...
            className={classNames(
              "__wab_instance",
              "Drawer__ariaDialog__mrubd",
              {
                Drawer__ariaDialognoTrigger__mrubdurZbM: hasVariant(
                  $state,
                  "noTrigger",
                  "noTrigger"
                )
          ...
          >
            ...
            >
              ...
              <div
                ...
                className={classNames(
                  "plasmic_default__all",
                  "Drawer__scrollableContent__qi0Ue"
                )}
              >
                {renderPlasmicSlot({
                  defaultContents: (
...
export const PlasmicDrawer__HeadOptions = {
