...
import "./PlasmicSwitch.css"; // plasmic-import: E5HZ464KS5FU/css
    ...
    >
      ...
      >
        <div
          ...
          className={classNames(
            "plasmic_default__all",
            "Switch__switchIndicator__m9946"
          )}
        >
          <div
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames("__wab_instance", "Switch__description__k2922")}
        />
      ) : null}
    </BaseSwitch>
...
export const PlasmicSwitch__HeadOptions = {
