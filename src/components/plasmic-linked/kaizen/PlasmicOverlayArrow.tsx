...
import "./PlasmicOverlayArrow.css"; // plasmic-import: 1D-b2FrFnV97/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: l48MK-_rb7LS/icon
  ...
  return (
    <BaseOverlayArrow
      ...
      className={classNames(
        ...
        "OverlayArrow__root___3WYz",
        {
          OverlayArrow__rootdark___3WYzZ1Lbo: hasVariant($state, "dark", "dark")
        }
      )}
    ...
    >
      <TriangleFilledIcon
        ...
        className={classNames(
          ...
          "OverlayArrow__svg__mgt1J",
          {
            OverlayArrow__svgdark__mgt1Jz1Lbo: hasVariant(
              $state,
              "dark",
              "dark"
            )
...
export const PlasmicOverlayArrow__HeadOptions = {
