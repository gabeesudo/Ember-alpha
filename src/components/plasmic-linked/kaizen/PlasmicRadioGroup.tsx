...
import Radio from "../../Radio"; // plasmic-import: pOaCm6xbE90a/component
...
import "./PlasmicRadioGroup.css"; // plasmic-import: EJyOIjgeUc3_/css
  ...
  return (
    <BaseRadioGroup
      ...
      className={classNames(
        ...
        "RadioGroup__ariaRadioGroup__sJe7W"
      )}
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "RadioGroup__label__rGdro")}
        >
          {renderPlasmicSlot({
        ...
        defaultContents: (
          <div
            className={classNames(
              ...
              "RadioGroup__freeBox__vEgwv"
            )}
          >
            <Radio
              className={classNames(
                "__wab_instance",
                "RadioGroup__radio___6OGFc"
              )}
              label={"Option 1"}
              value={"option1"}
            />
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames(
            "__wab_instance",
            "RadioGroup__description__c1Mbm"
          )}
        >
          {renderPlasmicSlot({
...
export const PlasmicRadioGroup__HeadOptions = {
