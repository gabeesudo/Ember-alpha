...
import "./PlasmicMenuSection.css"; // plasmic-import: X1QhDQLv858l/css
      ...
      header={
        <div
          ...
          className={classNames(
            ...
            "MenuSection__freeBox__qaPud"
          )}
        >
          {renderPlasmicSlot({
            defaultContents: "Section Header",
            value: args.header,
            className: classNames("MenuSection__slotTargetHeader__tFprL")
          })}
        </div>
      }
...
export const PlasmicMenuSection__HeadOptions = {
