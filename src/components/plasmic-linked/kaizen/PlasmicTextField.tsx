...
import TextInput from "../../TextInput"; // plasmic-import: SKaohZ2GTA5p/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: -4BsTlerLMPL/component
...
import "./PlasmicTextField.css"; // plasmic-import: iSlDKiH3hxVe/css
  ...
  return (
    <BaseTextField
      ...
      className={classNames(
        ...
        "TextField__ariaTextField__gnKE",
        {
          TextField__ariaTextFieldiconEnd__gnKEwqxjb: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          TextField__ariaTextFieldiconStart__gnKEikhA3: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          TextField__ariaTextFieldiconStart_iconEnd__gnKEikhA3Wqxjb:
            hasVariant($state, "iconStart", "iconStart") &&
            hasVariant($state, "iconEnd", "iconEnd"),
          TextField__ariaTextFieldmultiLine__gnKE15423: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "TextField__label__yhvmf", {
            TextField__labelmultiLine__yhvmf15423: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
      ...
      <div
        className={classNames(
          ...
          "TextField__freeBox__ntGc5",
          {
            TextField__freeBoxiconEnd__ntGc5Wqxjb: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            TextField__freeBoxiconStart__ntGc5IkhA3: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            TextField__freeBoxmultiLine__ntGc515423: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
      ...
      >
        <div
          className={classNames(
            "plasmic_default__all",
            "TextField__freeBox___7Rd2G",
            {
              TextField__freeBoxiconStart___7Rd2GikhA3: hasVariant(
                $state,
                "iconStart",
                "iconStart"
              ),
              TextField__freeBoxmultiLine___7Rd2G15423: hasVariant(
                $state,
                "multiLine",
                "multiLine"
              )
        ...
        >
          {renderPlasmicSlot({
            ...
            value: args.start,
            className: classNames("TextField__slotTargetStart__u3Qar", {
              TextField__slotTargetStarticonStart__u3QaRikhA3: hasVariant(
                $state,
                "iconStart",
                "iconStart"
              )
        ...
        {(hasVariant($state, "multiLine", "multiLine") ? true : false) ? (
          <TextAreaInput
            ...
            className={classNames("__wab_instance", {
              TextField__textAreaInputmultiLine__cL1YV15423: hasVariant(
                $state,
                "multiLine",
                "multiLine"
              )
        ...
        <div
          className={classNames(
            "plasmic_default__all",
            "TextField__freeBox__epDoC",
            {
              TextField__freeBoxiconEnd__epDoCwqxjb: hasVariant(
                $state,
                "iconEnd",
                "iconEnd"
              ),
              TextField__freeBoxiconStart__epDoCikhA3: hasVariant(
                $state,
                "iconStart",
                "iconStart"
              )
        ...
        >
          {renderPlasmicSlot({
            ...
            value: args.end,
            className: classNames("TextField__slotTargetEnd___0Btlg")
          })}
        </div>
      </div>
...
export const PlasmicTextField__HeadOptions = {
