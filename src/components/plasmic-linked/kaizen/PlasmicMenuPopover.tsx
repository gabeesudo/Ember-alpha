...
import "./PlasmicMenuPopover.css"; // plasmic-import: Jyqp42auz0GK/css
    ...
    >
      {(() => {
        const child$Props = {
          className: classNames(
            "__wab_instance",
            "MenuPopover__ariaListBox___1EsQg"
          ),
              ...
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuSection
                    className={classNames(
                      "__wab_instance",
                      "MenuPopover__menuSection__mlFf5"
                    )}
                    items={
                      <React.Fragment>
                        <MenuItem
...
export const PlasmicMenuPopover__HeadOptions = {
