...
import "./PlasmicSlider.css"; // plasmic-import: bUcI3Uqq8j14/css
...
function PlasmicSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
        ...
        >
          {$props.showLabel ? (
            <Label
              ...
              className={classNames("__wab_instance", "Slider__label__vrqgg")}
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
          ...
          {(() => {
            ...
            <BaseSliderOutput
              ...
              className={classNames(
                "__wab_instance",
                "Slider__ariaSliderOutput__vlgLu"
              )}
            >
              <React.Fragment>
      ...
      <div
        className={classNames("plasmic_default__all", "Slider__freeBox__sAlXo")}
      >
        <div
        ...
        >
          <BaseSliderTrack
            ...
            className={classNames(
              "__wab_instance",
              "Slider__ariaSliderTrack__bx2Mr"
            )}
            progressBar={
              $props.filled ? (
                <div
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames("__wab_instance", "Slider__description__dvdv")}
        />
      ) : null}
    </BaseSlider>
...
export const PlasmicSlider__HeadOptions = {
