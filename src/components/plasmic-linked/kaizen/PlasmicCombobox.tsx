...
import "./PlasmicCombobox.css"; // plasmic-import: 0H2LnqrYBUOK/css
  ...
  return (
    <BaseComboBox
      ...
      className={classNames(
        ...
        "Combobox__ariaComboBox__qEvAm",
        {
          Combobox__ariaComboBoxtype_plain__qEvAmK8Dlf: hasVariant(
            $state,
            "type",
            "plain"
          ),
          Combobox__ariaComboBoxtype_soft__qEvAm6YrT: hasVariant(
            $state,
            "type",
            "soft"
          )
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "Combobox__label__zj2Nk")}
        >
          {renderPlasmicSlot({
...
export const PlasmicCombobox__HeadOptions = {
