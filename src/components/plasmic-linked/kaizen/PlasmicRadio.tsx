...
import "./PlasmicRadio.css"; // plasmic-import: pOaCm6xbE90a/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames("plasmic_default__all", "Radio__freeBox__pwyqp")}
      >
        <div
          className={classNames("plasmic_default__all", "Radio__freeBox__j7Jf")}
        />
      </div>
      {renderPlasmicSlot({
...
export const PlasmicRadio__HeadOptions = {
