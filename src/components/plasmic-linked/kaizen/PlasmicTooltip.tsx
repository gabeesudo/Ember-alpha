...
import "./PlasmicTooltip.css"; // plasmic-import: waeVbOHmrWd5/css
  ...
  return (
        ...
        <React.Fragment>
          ...
          >
            {renderPlasmicSlot({
              ...
              value: args.content,
              className: classNames("Tooltip__slotTargetContent__mg7Jf")
            })}
          </div>
        </React.Fragment>
      }
    ...
    >
      {renderPlasmicSlot({
        ...
        value: args.trigger,
        className: classNames("Tooltip__slotTargetTrigger__lAhs5")
      })}
    </BaseTooltip>
...
export const PlasmicTooltip__HeadOptions = {
