...
import {
  PlasmicDashboard,
  PlasmicDashboard__HeadOptions
} from "../../components/plasmic-linked/kaizen/PlasmicDashboard";
import { createFileRoute } from "@tanstack/react-router";

export const Route = createFileRoute("/plasmic-dashboard/")({
  head: () => ({
    meta: [...PlasmicDashboard__HeadOptions.meta],
    links: [...PlasmicDashboard__HeadOptions.links]
  }),
  component: Dashboard
});
